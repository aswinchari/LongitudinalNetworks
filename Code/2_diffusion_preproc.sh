...
for i in sub*; do 
	...
	dwi_path=/media/rorypiper/gosh_nsgy/aswin/${GROUP}/input/source_data/${i}/${session_name}/dwi
	mkdir /media/rorypiper/gosh_nsgy/aswin/${GROUP}/output/dwi/${i}/
	mkdir /media/rorypiper/gosh_nsgy/aswin/${GROUP}/output/dwi/${i}/${session_name}
	output_path=/media/rorypiper/gosh_nsgy/aswin/${GROUP}/output/dwi/${i}/${session_name}
	...
	# RP.....I added this into the line above: -fslgrad dwi.bvec dwi.bval 
