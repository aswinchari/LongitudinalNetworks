%% Sensitivity Analysis 2 - across scles, without young patients
% Set-up
...
for a = 1:length(filelist)
    ...
    resections = resections([resections.age2] > 6);
...
sgtitle('Sensitivity Analysis Without Young Patients')
set(gcf,'position',[0 0 800 400])

%% Save

saveas(gcf,'PrelimFigs/SensAnal2.png')